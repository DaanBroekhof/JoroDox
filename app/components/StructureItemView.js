...
export default class StructureItemView extends Component {

    render() {

        if (!this.props.match.params.path) {
            return <Paper style={{flex: 1, margin: 20, padding: 20, alignSelf: 'flex-start'}}><p>Error during item load.</p></Paper>;
        }
